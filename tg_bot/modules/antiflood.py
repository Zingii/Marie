...
def check_flood(bot: Bot, update: Update) -> str:
    ...
    try:
        ...
        msg.reply_text("Başkalarını rahatsız etme artık bu grupta snana gerek yok...")
...
__help__ = """
 - /flood: Mesaj kontrolünüzü bilmek için kullanabilirsiniz..

*Admin only:*
 - /setflood <int/'no'/'off'>: flood kontrolünüzü etkinleştirir veya devre dışı bırakır.
"""
