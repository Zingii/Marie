...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    try:
        ...
        message.reply_text("Yetkisi alındı!")
        return "<b>{}:</b>" \
               "\n#DEMOTED" \
               "\n<b>Admin:</b> {}" \
               "\n<b>User:</b> {}".format(html.escape(chat.title),
...
*Sadece yönetici:*
 - /pin: Mesajı sabitlemek için yanıtlayarak bu komutu kullanın. Kullanıcılara bildirim gönderip/göndermemek için 'loud' veya 'notify' kullanın.
 - /unpin: Sabitlenmiş mesajı kaldırır.
 - /invitelink: davet linki verir.
 - /promote: üyeleri yönetici yapmak için kullanabilirsin.
 - /demote: üyeleri yöneticilikten çıkarmak için kullanabilirsin.
"""
