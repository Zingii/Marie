...
{}
Ve aşağıdakiler:
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "\nTüm komutlarda / veya ! kullanılabilir...\n")

DONATE_STRING = """Sea len mq :D [Sahibimle iletişim](t.me/dasqinnagiyev) / [Instagram hesabı](instagram.com/dasqinnagiyev), ve [Telegram hesabı](t.me/daqomods)."""
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 580282427 and DONATION_LINK:
            update.effective_message.reply_text("PayPal üzerinden bağış yapmak için "
                                                "[buraya dokun]({})".format(DONATION_LINK),
                                                parse_mode=ParseMode.MARKDOWN)
